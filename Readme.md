...
class RoomSerializer(serializers.ModelSerializer):#Create serializer
...
- ## Setup
  ...
  npm install react-router-dom@5 --save-dev
  ```
  ...
  - Create index.js inside src as entry-point of React and import the React App
  ...
  export default class App extends Component {
    //Export this class as default and inherit Component class
    constructor(props) {
      //Make constructor
      super(props);
    }
